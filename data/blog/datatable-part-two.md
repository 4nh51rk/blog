...
In this part, we will be covering sorting our data in either ascending or descending order, which we will be handled on the frontend and requires no backend communication.
